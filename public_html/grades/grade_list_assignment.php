...
$resource = mysql_query("select student_id, ass_grades.sec_id, ass_id, points, points_poss, title from ass_grades inner join assignments on ass_grades.ass_id = assignments.id order by ass_grades.student_id", $link);
