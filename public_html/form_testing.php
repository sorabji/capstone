...
<body>
  ...
  <form action="/code/css/forms/" method="post" enctype="multipart/form-data">
    ...
    <fieldset><legend>Verification</legend>
      <input type="hidden" name="captcha_hash" value="00F4D57F59FD2F739100A5A6DC879467" />
      <input type="hidden" name="captcha_file" value="DF29ABA0-AA4E-0BBA-C26AD6D6E063BF22.jpg" />
      <div class="notes">
      ...
      <div class="required">
        ...
        <img src="/images/captcha/DF29ABA0-AA4E-0BBA-C26AD6D6E063BF22.jpg" border="0" alt="" />
      </div>
      <div class="required">
