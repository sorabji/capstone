...
abstract class Table {
  ...
  abstract protected function get_insert_qry($vals);
  abstract protected function get_update_qry($vals);
  abstract protected function get_drop_qry($vals);
...
class People_Table extends Table{
  ...
  public function get_insert_qry($vals){
  ...
  public function get_drop_qry($vals){
    return 0;
  }

}

class Instructors_Table extends Table{
