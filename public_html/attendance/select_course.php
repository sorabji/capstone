...
/////////////TO VIEW EXISTING RECORDS BY COURSE:	
	...
	*/
	...
	/////////////TO VIEW EXISTING RECORDS BY STUDENT:	
		else if (isset($_POST['submit_course_stud_view'])) {
		//declaring variables to use when 'submit_course_view' is pressed
...
//////////////
		...
		echo "";	
//
	echo '<center><div width=\"450px\"><h3>Select a course and section.</h3>';
	...
	echo '<input type = "Submit" name = "submit_course_new" value = "Enter Attendance for This Class"><br /><br />';
	echo '<input type = "Submit" name = "submit_course_date_view" value = "View Records for This Class by Date"><br /><br />';
	echo '<input type = "Submit" name = "submit_course_stud_view" value = "View Records From This Class by Student"></form></div></center>';
